        ...
        <div class="p-8">
            ...
            @elseif ($status === 'confirm')
                <div class="mb-6 text-center">
                    <div class="mx-auto w-12 h-12 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center mb-3">
                ...
                <form wire:submit.prevent="konfirmasiAktivasi" class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="input_identifier" wire:model.defer="input_identifier"
                            class="w-full px-4 py-2.5 rounded-lg border @error('input_identifier') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                    ...
                    <div>
                        ...
                        <input type="password" id="new_password" wire:model.defer="new_password"
                            class="w-full px-4 py-2.5 rounded-lg border @error('new_password') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            class="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm rounded-lg shadow transition flex items-center justify-center gap-2">
                ...
                <div class="text-center py-4">
                    ...
                    <div class="mt-6">
                        <a href="{{ url('/internal/login') }}"
                            class="inline-block w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm rounded-lg shadow transition">
            ...
            @elseif ($status === 'error')
                <div class="text-center py-4">
                    ...
                    <div class="mt-6 space-y-2">
                        @if ($alreadyActive)
                            <a href="{{ url('/internal/login') }}"
                                class="inline-block w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm rounded-lg shadow transition">
                                Menuju Halaman Login
                            </a>
                        @else
                            <a href="{{ url('/') }}"
                                class="inline-block w-full py-2.5 px-4 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold text-sm rounded-lg transition">
                                Kembali ke Beranda
                            </a>
                        @endif
                    </div>
